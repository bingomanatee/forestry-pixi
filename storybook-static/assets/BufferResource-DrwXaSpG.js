import{w as U,m as g,n as c,u as S,B as _,o as m,E as I,p as h}from"./Button.stories-DaRmI_uS.js";const x={name:"local-uniform-bit",vertex:{header:`
    ...
    `];let n=0;for(let d=0;d<e.length;d++){const f=e[d],b=f.data.name;let y=!1,i=0;for(let u=0;u<p.length;u++)if(p[u].test(f.data)){i=f.offset/4,r.push(`name = "${b}";`,`offset += ${i-n};`,p[u][t]||p[u].ubo),y=!0;break}if(!y)if(f.data.size>1)i=f.offset/4,r.push(a(f,i-n));else{const u=s[f.data.type];i=f.offset/4,r.push(`
                    v = uv.${b};
                    offset += ${i-n};
                    ${u};
                `)}n=i}const o=r.join(`
